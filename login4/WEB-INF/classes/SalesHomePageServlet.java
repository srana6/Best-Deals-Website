...
public class SalesHomePageServlet extends HttpServlet implements Serializable {
    ...
    throws ServletException, java.io.IOException {
		...
		pw.println("<body>"+
                                ...
                                {                   
                                    k = hm.getKey();
                                        ...
                                        for(SalesModel prod : productList){
											...
											/*pw.println("<form action='/login4/DeleteProductFromCartServlet' method='get' style='margin-bottom:20px;'>"+
			...
			pw.println("<form method='post' action='/login4/CancelOrderServlet'>"+"<p>Enter the Order ID which you want to Cancel</p>");
			...
			pw.println("<form method='post' action='/login4/UpdateOrderServlet'>"+"<p>Enter the Order ID which you want to Update</p>");
