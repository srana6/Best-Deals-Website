...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, java.io.IOException 
    {
        ...
        pw.println(	"<html>"+
					...
					"<body>"+
					"<div id='container'>"+
					"<header>" + "<div class='header_logo'>" + "<img src='images/best_deals.png'/>" + "<h1><a href='/login4/LoginServlet'>BEST <span>DEAL</span></a></h1>"+
					"<h2>new deals everyday</h2>"+ 
					"</div>" + 
					"</header>"+
					"<h4>" + "<span style='width:310px;display:inline-block'></span>" + "Your Product Has Been Added" + "</h4>"+
					"<span style='width:310px;display:inline-block'></span>"+"<a href='/login4/AdminHomePageServlet'>Due to extra security Please login again to see the changes</a>"+
					"</body></html>");
        pw.close();        
