...
public class DeleteProductFromCartServlet extends HttpServlet implements Serializable{
	...
	//response.sendRedirect("/login4/ActualLogicDeleteFromCartServlet");
	...
	pw.println(	"<html>"+
					...
					"<span style='width:310px;display:inline-block'></span>"+"<a href='/login4/ProductCartServlet'>Due to Extra Security Reasons click here to see the changes</a>");  
