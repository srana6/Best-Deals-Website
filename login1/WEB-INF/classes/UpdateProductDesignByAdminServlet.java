...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, java.io.IOException 
    {
        ...
        String user=((String)session.getAttribute("userid"));
                        ...
                        try{  
								...
								if(firstLetter.equals("t")){
                                	productcategory = "TV";
                                    tvList = mapInFile.get("TV"); //bring elements of TV into tvList.
        ...
        pw.println(	"<html>"+
					...
					"<form method='post' action='/login1/UpdateProductByAdminServlet'><h3>Edit Products</h3><table cellpadding='2' cellspacing='1'>"+
