...
public class UpdateOrderHistoryServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException 
    {
        ...
        pw.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/login2/SalesHomePageServlet'>Click here to redirect</a>");
		}
		else{
        pw.println("<h4>" + "<span style='width:310px;display:inline-block'></span>" + "Your Order Has Been Updated Successfully" + "</h4>");
        pw.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/login2/OrderHistoryServlet'>Click here to redirect</a>");
		}
        pw.close();  
