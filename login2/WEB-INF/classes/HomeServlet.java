...
public class HomeServlet extends HttpServlet {
    ...
    */
	...
	public void loadLoginPage(HttpServletRequest request,HttpServletResponse response) throws ServletException, java.io.IOException{
		...
		pw.println("<body><div id='container1'><header><div id=imageLogo><img src='images/best_deals.png'/><h1><a href='/login2/HomeServlet'>Best<span>Deals</span></a></h1>"+
					"<h2>new deals everyday</h2></div></header></div>");
					
		pw.println("<div class='login-page'>"+
					"<div class='form'>"+
					"<form class='register-form' method='post' action='/login2/SignUpServlet'>"+
					...
					"</form>"+
					"<form class='login-form' method='post' action='/login2/LoginServlet'>"+
