/*
USER CLICKS ON LAPTOP IN HOME PAGE AND LAPTOP DATA STORE SERVLET IS CALLED
*/
...
public class LaptopDataStoreServlet extends HttpServlet implements Serializable{
	...
	public void printHtmlPage(HttpServletRequest request,HttpServletResponse response) throws ServletException, java.io.IOException{
		...
		productList=SaxParser.m.get("Laptop");
		...
		pw.println("<body>"+
					...
					*/
					...
					"<section id='content'>"+
					"<article>"+
					"<h2>CHOOSE YOUR LAPTOP TODAY</h2>");
					/*
					TRAVERSING THORUGH PRODUCT LIST WHICH HAS DATA OF LAPTOP
					*/
