...
public class SubmitReviewToMongoServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			pw.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/login5/TvDataStoreServlet'>Due to Extra Security Reasons click here to see the changes</a>");  
					}
					else if(category.equals("Laptop")){
			pw.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/login5/LaptopDataStoreServlet'>Due to Extra Security Reasons click here to see the changes</a>");  
					}
					else if(category.equals("Phone")){
			pw.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/login5/PhoneDataStoreServlet'>Due to Extra Security Reasons click here to see the changes</a>");  
					}
					else if(category.equals("Tablet")){
			pw.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/login5/TabletDataStoreServlet'>Due to Extra Security Reasons click here to see the changes</a>");  
					}
					pw.close();
