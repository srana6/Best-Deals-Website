...
public class MySqlDataStore
{
		...
		public static HashMap<String, Products> selectAllProducts_hash;
...
public static HashMap<String,Products> getData(){
			...
			while (rs.next()) {
					...
					Products p = new Products(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getString(5) );
