...
public class CancelOrderServlet extends HttpServlet {
    ...
    {      
		...
		pw.println("<h3>" + "<span style='width:310px;display:inline-block'></span>" + "Your Order has Been Canceled" + "</h3>"+
					"<span style='width:310px;display:inline-block'></span>"+"<a href='/login5/SalesHomePageServlet'>click here to see the changes</a>");  
					}
					else{
		pw.println("<h3>" + "<span style='width:310px;display:inline-block'></span>" + "Your Order has Been Canceled" + "</h3>"+
					"<span style='width:310px;display:inline-block'></span>"+"<a href='/login5/OrderHistoryServlet'>click here to see the changes</a>");  
					}
